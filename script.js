...
// ==========================================
// SWIPER 3D CARD SLIDER (YENİ)
// ==========================================

// Ekran boyutuna göre yönü belirle
const isMobile = window.innerWidth < 768;

var swiper = new Swiper(".mySwiper", {
    effect: "coverflow", // 3D Efektin adı
    grabCursor: true,    // Mouse tutma ikonu
    centeredSlides: true, // Kart ortada dursun
    slidesPerView: "auto", // Ekrana sığdığı kadar
    
    // Masaüstünde YATAY, Mobilde DİKEY
    direction: isMobile ? "vertical" : "horizontal",
    
    coverflowEffect: {
        rotate: 50,      // Dönüş açısı (Platform hissi)
        stretch: 0,
        depth: 100,      // Derinlik
        modifier: 1,
        slideShadows: true, // Gölge olsun mu
    },
    pagination: {
    ...
    // İlk açılışta 1. kart (Web Yazılım) seçili olsun
    initialSlide: 0 
});

// Ekran boyutu değişirse sayfayı yenile (Yatay/Dikey geçişi için)
window.addEventListener('resize', () => {
